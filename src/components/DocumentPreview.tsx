                  ...
                  {Array.from({ length: colCount }, (_, cIdx) => {
                    ...
                    return (
                      <td key={cIdx} className="relative p-0"
                        ...
                        {rIdx === 0 && cell.borders.top.type !== 'NONE' && <div className="absolute top-0 left-0 right-0 bg-black/60" style={{ height: borderLW(cell.borders.top) }} />}
                        ...
                        {cIdx === 0 && cell.borders.left.type !== 'NONE' && <div className="absolute top-0 left-0 bottom-0 bg-black/60" style={{ width: borderLW(cell.borders.left) }} />}
